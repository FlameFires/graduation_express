		...
		<div class="ui center aligned grid">
			<div class="column viewh">
				<div class="ui segment">
					<courier-head v-bind:active=3></courier-head>
					<img src="@/static/images/kdk.png" class="image left aligned"
						style="margin-top:20px;width: 70px;border-radius: 50px">
					...
					<div class="ui segment">
						<div class="ui relaxed divided list selection">
							<div class="item">
								<div class="content">
									<navigator url="/pages/courier/selfInfo">
							...
							<div class="item">
								<div class="content">
									<navigator url="/pages/courier/account">
