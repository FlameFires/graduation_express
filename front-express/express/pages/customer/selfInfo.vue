			...
			<div class="column viewh">
				...
				<div class="ui segment">
					<form class="ui form" style="margin-top: 50px">
						...
						<img src="/static/images/kdk.png" class="image"
							style="width: 100px;border-radius: 50px;margin-top: 10px;">
						...
						<div class="field">
							<div class="ui left icon input">
								...
								<input type="text" name="address" placeholder="请输入地址详细到宿舍门牌号" v-model="info.address">
							</div>
						</div>
						<div class="field">
							<div class="ui left icon disabled input">
								<i class="phone icon"></i>
								<input type="text" name="mobile" placeholder="请输入手机号/校园短号" readon :value="info.phone">
							</div>
						</div>
						<div class="field">
						...
						<navigator url="me" class="ui fluid  submit button">返回</navigator>
	...
	export default {
		...
		methods: {
			save: function() {
				...
				this.$req.user.saveSelfInfo('C', this.info, (res) => {
					let data = res.data;
					if (data.status) {
